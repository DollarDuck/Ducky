...
import {Budget, EditBudget, Login, Signup, UserHome, Onboarding, OnboardingBudget, Plaid, Dashboard, Bills, NewBillForm, OnboardingLink, Balances, Transactions, BudgetDetail, EditUser, UserProfile} from './components'
  ...
  render() {
    ...
    return (
      <Switch>
        ...
        <Route path="/editBudget" component={EditBudget} />
        {isLoggedIn && (
          <Switch>
